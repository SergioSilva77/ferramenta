...
| [Desktop](modulos/desktop.md) | Automação via reconhecimento de imagem | `pip install rpaflow[desktop]` |
| [Log](modulos/log.md) | Logging profissional (inspirado no Serilog) | `pip install rpaflow[log]` |
| [INI](modulos/ini.md) | Leitura e escrita de arquivos .ini | `pip install rpaflow[ini]` |
...
| [Email](modulos/email.md) | Envio de emails SMTP | `pip install rpaflow[email]` |
